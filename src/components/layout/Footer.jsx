      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-light tracking-[0.2em] text-gradient uppercase mb-6">Radheshyam</h2>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-[var(--text-secondary)] text-sm">Near Radheshyam Eye Clinic</li>
              <li className="text-[var(--text-secondary)] text-sm">Ram Mantra Mandir, Bhavnagar-364001, Gujarat</li>
              <li className="text-[var(--text-secondary)] text-sm">+91 86730 77070</li>
              <li className="text-[var(--text-secondary)] text-sm">support@radheshyam.com</li>
            </ul>
          </div>
        </div>
        <div className="mt-16 pt-8 border-t border-[var(--border-color)] flex flex-col md:flex-row justify-between items-center">
          <p className="text-[var(--text-faint)] text-xs">© {new Date().getFullYear()} Radheshyam Chashmaghar. All rights reserved.</p>
